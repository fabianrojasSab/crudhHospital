...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="row justify-content-md-center p-4">
            <h3>HOSPITALIZAR PACIENTE</h3>
            <div class="col-12 .col-md-4  col-xl-4 p-4">
                <form class="col align-self-center p-4" action="{{ route('gestionhospitalaria.store')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="no_doc_paciente" value="{{$res[2]->no_documento}}" >
                    </div>
                    <div class="form-group">
                        <label for="nombres">Nombres</label>
                        <input type="text" class="form-control" name="nombres" value="{{$res[2]->nombres}}" >
                    </div>
                    <div class="form-group">
                        <label for="apellidos">Apellidos</label>
                        <input type="text" class="form-control" name="apellidos" value="{{$res[2]->apellidos}}" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="fec_ingreso" value="">
                    </div>  
                    <br>
                    <button type="submit" class="btn btn-primary">Resgistrar hospitalizacion</button>
