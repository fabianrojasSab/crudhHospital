    ...
    <body class="antialiased">
        ...
        <div class="row justify-content-md-center p-4">
            ...
            <div class=" col-12 .col-md-4  col-xl-4 p-4">
                <form class="col align-self-center p-4" action="{{ route('hospitales.destroy', $hospital->cod_hospital)}}" method="POST">
                    @csrf
                    @method('DELETE')
                    <h3>ESTA SEGURO QUE DESEA ELIMINAR EL HOSPITAL?</h3>
                    <br>
                    <button type="submit" class="btn btn-danger">ELIMINAR hospital</button>
                </form>
                <a href="{{route('hospitales.index')}}">regresar</a>
            </div>
        </div>
